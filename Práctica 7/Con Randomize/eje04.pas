  ...
  begin
    with r do
      begin
        ...
        dimL:= 0;
        apellido:= Concat('Apellido-',IntToStr(random(4000)));
        nombre:= Concat('Nombre-',IntToStr(random(4000)));
        //Como a lo sumo puede haber 42 pesos, signifca que no esta cargado si o si el vector,
        //En este caso para ser mas rapido, cargo todo el vector
        while (dimL < dimF) do
          begin
            dimL:= dimL + 1;
            peso[dimL]:= (random(10) + 1);
          end;
      end;  
  end;
