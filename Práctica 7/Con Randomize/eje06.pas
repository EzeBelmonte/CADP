    ...
    with r do
      begin
        ...
        if (cod <> - 1) then
          begin
            categ:= random(7) + 1;
            nomObj:= Concat('Objeto-',IntToStr(random(3000)));
            distancia:= random(30000);
            nomDes:= Concat('Descubridor-',IntToStr(random(500)));
            anioDes:= random(523) + 1500;
          end;
      end;
  end;
