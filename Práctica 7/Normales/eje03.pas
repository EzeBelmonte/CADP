...
procedure preguntas (var r: REG_viaje);
  begin
    with r do
      begin
        write ('Num. de viaje: '); readln(numViaje);
        write ('Cod. de auto: '); readln(codAuto);
        write ('Direccion de origen calle 1: '); readln(dir1S);
        write ('Direccion de origen calle 2: '); readln(dir2S);
        write ('Direccion de destino calle 1: '); readln(dir1D);
        write ('Direccion de destino calle 2: '); readln(dir2D);
        write ('Km de recorrido: '); readln(km);
      end;
  end;
